...
RESTRICTED_ACTION_STATES = {
    ...
    ('pharmacovigilance', 'actions', 'start'): ('status', ('pending',)),
    (
        'pharmacovigilance',
        'cases',
        'cancel',
    ): ('status', ('draft', 'triage', 'investigation', 'pending_actions', 'cancelled')),
    (
        'pharmacovigilance',
        'cases',
        'close',
    ): ('status', ('investigation', 'pending_actions')),
    ('pharmacovigilance', 'cases', 'start_investigation'): ('status', ('triage',)),
    ('pharmacovigilance', 'cases', 'start_triage'): ('status', ('draft',)),
    ...
    ('regulatory', 'dossiers', 'close'): ('status', ('submitted', 'under_review', 'approved')),
    ('regulatory', 'dossiers', 'submit'): ('status', ('draft',)),
    ('regulatory', 'petitions', 'submit'): ('status', ('draft',)),
